        ...
        { type: 'separator' },
         { 
            ...
            subItems: [
                ...
                // --- THIS IS THE DATA THAT WAS WRONG ---
                { path: "/dashboard/support-tickets", nameKey: "sidebar.support_tickets" },
            ]
        },
                          ...
                          return (
                            <React.Fragment key={item.nameKey}>
                                ...
                                {isHelpMenuOpen && !isCollapsed && (
                                    <SubMenu>
                                      <MenuItem>
                                        {/* This link is correct, as /knowledge-base is public */}
                                        <StyledNavLink to="/knowledge-base"><MenuText>Knowledge Base</MenuText></StyledNavLink>
                                      </MenuItem>
                                      <MenuItem>
                                        {/* --- THIS IS THE FIX --- */}
                                        <StyledNavLink to="/dashboard/support-tickets"><MenuText>Support Tickets</MenuText></StyledNavLink>
                                      </MenuItem>
                                    </SubMenu>
                                )}
                            </React.Fragment>
