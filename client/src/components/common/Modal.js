...
const ModalButton = styled.button.attrs(props => ({
    // Pass the external 'variant' prop as an internal transient prop '$variant'
    // Styled Components will automatically filter transient props (starting with $)
...
  font-weight: bold;
  cursor: pointer;
  // Use the transient prop '$variant' internally for styling
