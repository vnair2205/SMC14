...
const CategoryButton = styled.button`
  ...
  /* --- FIX: Use transient prop $isActive --- */
...
// (SearchContainer, SearchInput, SearchIcon, BlogGrid, BlogCard... no changes)
                    ...
                    <BlogGrid>
                        {blogs.length > 0 ? blogs.map(blog => (
                            <BlogCard key={blog._id}>
                                {/* --- FIX: Remove hardcoded URL. The backend will now provide the full path --- */}
                                <CardThumbnail src={blog.thumbnail} alt={blog.title} />
                                <CardContent>
