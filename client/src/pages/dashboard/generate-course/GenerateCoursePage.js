...
// import axios from 'axios'; // <-- FIX: Removed
...
// --- FIX: Corrected the import path for api ---
...
const GenerateCoursePage = () => {
    ...
    const handleTopicSubmit = async () => {
        ...
        try {
            ...
            const body = { topic, languageName, nativeName };
            const res = await api.post('/course/refine-topic', body);
    ...
    const proceedToObjectiveGeneration = async (selectedSuggestion) => {
        ...
        try {
            ...
            const res = await api.post('/course/generate-objective', body);
    ...
    const handleAddObjective = async (objectiveText) => {
        ...
        try {
            ...
            const res = await api.post('/course/refine-objective', body);
    ...
    const handleObjectiveSubmit = async () => {
        ...
        try {
            ...
            const body = { courseId, topic, objective: finalObjectives, language, languageName, nativeName, englishTopic };
            
            const res = await api.post('/course/generate-outcome', body);
    ...
    const handleGenerateIndex = async (callback) => {
        ...
        try {
            ...
            const body = { courseId, topic, objective, outcome, numSubtopics, language, languageName, nativeName, customLessons, englishTopic };
            
            const res = await api.post('/course/generate-index', body);
