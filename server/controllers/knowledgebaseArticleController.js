...
exports.deleteArticle = async (req, res) => {
  try {
    // FIX: Use the modern, atomic Mongoose method findByIdAndDelete() 
    // to find and remove the article in a single step.
    ...
    // The deletion is handled by findByIdAndDelete, so we simply return success.
