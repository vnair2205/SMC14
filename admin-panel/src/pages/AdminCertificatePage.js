...
// import axios from 'axios'; // <-- OLD: REMOVED AXIOS
import api from '../services/api'; // <-- NEW: IMPORT CONFIGURED API INSTANCE
...
const AdminCertificatePage = () => {
    ...
    // Assuming the client app URL is app.seekmycourse.com
    ...
    useEffect(() => {
        const fetchCertificateData = async () => {
            ...
            try {
                // *** FIX: Use the 'api' instance and remove '/api' from the path ***
                // New URL: /admin/course-details/ + courseId (Base URL: https://api.seekmycourse.com/api)
                const res = await api.get(`/admin/course-details/${courseId}`, config);
                setCourse(res.data);
